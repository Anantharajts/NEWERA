...
$brand=$_POST['brand'];
    ...
    if (mysqli_query($con, $deleted)) {
        ...
        echo "deleted";
        echo "<script>window.location.href='brand_add_section.php'</script>";
        ...
        <div class="col" style="background-color:white;border-radius: 10px;height: 220px;">
            <form action="brand_action.php" method="post" onsubmit="return valid()">
                <div class="row" style="flex-direction: column;gap:20px;padding:20px;text-align: center;">
                    ...
                    <div class="col">
                        <input type="text" name="brand" id="brandid" oninput="removevalidation('brandid')"value="<?php echo $brand?>"
                            style="width: 100%;padding:10px;">
                            <input type="hidden" name="bid" id="b_id" value="<?php echo $id?>">
                    </div>
                    <div class="col">
                        <button type="submit" name="b_addbtn"
                            style="width: 100%;background-color:black;color:white;padding-top:5px;padding-bottom:5px;"><?php echo $id == 0? "ADD":"UPDATE"?></button>
                    </div>
                </div>
            </form>
        </div>
