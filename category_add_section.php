...
<div class="container" style="margin-top: 100px;">
    <div class="row" style="gap: 20px;">
        <div class="col" style="border-radius: 10px;background-color:white;">
            <div class="row" style="padding: 10px;gap:20px;flex-direction: column; text-align:center;">
                <div class="col">
                    <h3>Category add section</h3>
                </div>
                <div class="col">
                    <input type="text" name="category" id="categoryid" style="width: 100%; padding:10px;">
                </div>
                <div class="col">
                    <button name="cate_addbtn" id="cate_addbtnid" style="padding: 5px 273px;background-color:black;color:white;">ADD</button>
                </div>
            </div>
        </div>
