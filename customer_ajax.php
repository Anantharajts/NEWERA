...
$query = "SELECT PA.`Id`, PA.`Name`, `Image`,`BrandId`,`CategoryId`, PA.`Price`, `Quantity`,CASE WHEN `Status`=0 THEN 'Instock' 
...
if ($price != "") {
    ...
    $query = $query . " AND  PA.`Price`". $price;
}
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $product_html .= '<div class="col sh_im1" style="border-radius: 10px;background-color: #F1F1F1;">'.
                            '<div class="col"><img src="assets/IMG/dress/'.$row['Image'].'" class="img-fluid"></div>'.
                        '</div>'.
                       ...
                       ' <div class="row" style="gap:5px;text-align: -webkit-center;flex-direction: column;">'.
                           ...
                           ' <div class="col">'.
                               ...
                               ' <button class="fav-btn" id="favBtn" style="display: flex;align-items: center;gap: 10px;background: #000000;color: white;border: none;padding: 6px 20px;border-radius: 5px;width: 100%;font-size: 16px;'.
