...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $books_html .= '<td style="padding-top: 40px;">' . $row['Brandname'] . '</td>';
    $books_html .= '<td style="padding-top: 40px;">' . $row['category'] . '</td>';
    $books_html .= '<td style="padding-top: 40px;">' . $row['Price'] . '</td>';
    $books_html .= '<td style="padding-top: 40px;">' . $row['Quantity'] . '</td>';
    $books_html .= '<td style="padding-top: 40px;">' . $row['Status'] . '</td>';
