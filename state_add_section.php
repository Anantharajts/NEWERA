...
<div class="container" style="margin-top: 100px;">
    <div class="row" style="gap: 20px;">
        <div class="col" style="background-color:white;padding:20px;border-radius: 10px;">
            ...
            <form action="state_add_section.php" method="post" onsubmit="return valid()">
                <div class="row" style="gap: 20px;flex-direction: column;text-align: center;padding: 20px;">
                    ...
                    <div class="col">
                        <input type="text" name="state" id="stateid" oninput="removevalidation('stateid')" style="padding:10px;width:75%;">
                    </div>

                    <div class="col">
                        <button class="s_addbtn" type="submit">ADD</button>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form action="#" method="post">
                                ...
                                <td style="padding-top: 15px;">C</td>
                                <td style="padding-top: 15px;">S</td>
                                <td>
